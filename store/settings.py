...
MEDIA_ROOT = '/opt/bikesto_com_ua/media'
...
STATIC_ROOT = '/opt/bikesto_com_ua/static'
STATIC_URL = '/static/'
...
SECRET_KEY = '%cu*v-%zv**-m9w461w_ts(j!g8mhhb!rp=8z+min5j#sfgbeh'
...
L10N_SETTINGS = {
  'currency_formats': {
    'UAH' : {'symbol': u'', 'positive': u"%(val)0.2f", 'negative': u"(%(val)0.2f)",
      'decimal': '.'},
  },
